...
namespace MechMK1.ConsoleScreenbuffers
{
    internal static class NativeMethods
    {
		...
		/// </summary>
		/// <param name="handle">The standard device. See StandardDevice</param>
		...
		internal static extern IntPtr GetStdHandle(StandardDevice handle);
		
		/// <summary>
		/// Creates a console screen buffer.
		/// </summary>
		/// <param name="dwDesiredAccess">The access to the console screen buffer. See AccessRights.</param>
		/// <param name="dwShareMode">This parameter can be zero, indicating that the buffer cannot be shared, or it can be one or more of the following values. See ShareModes.</param>
